...
def get_about():
    ...
    about = dict()
    with open("ecsctrl/__init__.py", "r") as f:
        dunders = list()
    ...
    with open(path.join(path.dirname(__file__), "ecsctrl", "VERSION")) as f:
...
setup(
    ...
    url="http://github.com/wlatanowicz/ecsctrl",
